<x-error-layout>
    <h1 class="w-full select-none text-center text-6xl sm:text-7xl md:text-8xl font-black leading-none text-gray-400">
        500</h1>
    <p class="text-center text-xl font-bold capitalize">Kesalahan Server</p>
    <p class="mx-auto max-w-2xl text-center text-base sm:text-lg font-medium break-words text-gray-500">Terjadi kesalahan
        pada server. Silakan coba lagi beberapa
        saat, atau kembali ke dashboard.</p>
