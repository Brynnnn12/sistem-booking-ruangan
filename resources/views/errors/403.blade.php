<x-error-layout>
    <h1 class="text-6xl md:text-[300px] w-full select-none text-center font-black text-gray-400">
        403</h1>
    <p class="text-xl font-bold capitalize">Akses Ditolak</p>
    <p class="text-lg font-medium break-words text-gray-500">Maaf, Anda tidak memiliki izin untuk mengakses halaman ini.
    </p>
