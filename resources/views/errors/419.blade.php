<x-error-layout>
    <h1 class="text-6xl md:text-[300px] w-full select-none text-center font-black text-gray-400">
        419</h1>
    <p class="text-xl font-bold capitalize">Sesi Kadaluwarsa</p>
    <p class="text-lg font-medium break-words text-gray-500">Sesi Anda telah berakhir. Silakan muat ulang halaman dan
        coba lagi.</p>
