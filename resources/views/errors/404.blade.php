<x-error-layout>
    <h1 class="text-6xl md:text-[300px] w-full select-none text-center font-black text-gray-400">
        404</h1>
    <p class="text-xl font-bold capitalize">Halaman Tidak Ditemukan</p>
    <p class="text-lg font-medium break-words text-gray-500">Halaman yang Anda cari tidak ditemukan. Silakan cek kembali
