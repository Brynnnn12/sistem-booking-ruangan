<x-error-layout>
    <h1 class="w-full select-none text-center text-6xl sm:text-7xl md:text-8xl font-black leading-none text-gray-400">
        404</h1>
    <p class="text-center text-xl font-bold capitalize">Halaman Tidak Ditemukan</p>
    <p class="mx-auto max-w-2xl text-center text-base sm:text-lg font-medium break-words text-gray-500">Halaman yang Anda
        cari tidak ditemukan. Silakan cek kembali
        URL atau kembali ke dashboard.</p>
