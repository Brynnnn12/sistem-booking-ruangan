...
class UpdateBookingRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'start_time'    => ['sometimes', 'date_format:H:i', 'after_or_equal:07:00', 'before_or_equal:16:00'],
            'end_time'      => ['sometimes', 'date_format:H:i', 'after:start_time', 'after_or_equal:08:00', 'before_or_equal:17:00'],
